...
create table trigtst1col (col integer primary key);
...
create table trigtst1dcol (col text primary key, dcol text);
...
drop table trigtst cascade;
drop table trigtst1col cascade;
drop table trigtst1col2 cascade;
drop table trigtst1dcol cascade;
drop function misctrig() cascade;
drop function modtrig1() cascade;
drop function modtrig2() cascade;
drop function modtrig3() cascade;
drop function modtrig4() cascade;
drop function modtrig5() cascade;
drop function modtrig6() cascade;
drop function modtrig7() cascade;
drop function modtrig8() cascade;
drop function modtrig9() cascade;
drop function modtrig10() cascade;
drop function modtrig11() cascade;
drop type t2col cascade;
