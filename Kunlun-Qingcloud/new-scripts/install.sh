...
then
	...
	sudo docker run -itd --env METASEEDS=$metaCluster --name xpanel1 -p $port:80 registry.cn-hangzhou.aliyuncs.com/kunlundb/kunlun-xpanel:$VERSION bash -c '/bin/bash /kunlun/start.sh'
