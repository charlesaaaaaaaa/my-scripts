...
--package.path ="/home/charles/MyTools/Packages/sysbench-tpcc-cus/tpcc_run-fs.lua"..";..\\?.lua"
--package.path ="/home/charles/MyTools/Packages/sysbench-tpcc-cus/tpcc_check-fs.lua"..";..\\?.lua"
require("tpcc_common")
require("tpcc_run")
require("tpcc_check")
